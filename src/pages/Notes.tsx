...
import { IconNotes, IconClock } from '@tabler/icons-react';
      ...
      <Stack gap='xl'>
          ...
          <Stack gap='lg' align='center' ta='center'>
            ...
            <Stack gap='sm' align='center'>
              ...
              <Text size='lg' c='dimmed' maw={500}>
                Pracujemy nad zaawansowanym systemem notatek terapeutycznych z
                podporą dla metod SOAP, CBT i innych standardów dokumentacji.
              </Text>
            </Stack>
        ...
        <Card shadow='sm' padding='lg' radius='md' withBorder>
          <Stack gap='md'>
            ...
            <Stack gap='xs'>
              <Text size='sm'>
                📝 Notatki w formacie SOAP (Subjective, Objective, Assessment,
                Plan)
              </Text>
