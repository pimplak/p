...
export function SMSTemplateManager() {
    ...
    const handleDeleteTemplate = (templateId: string) => {
        ...
        const isDefaultTemplate = DEFAULT_SMS_TEMPLATES.some(dt => dt.id === templateId);
        if (isDefaultTemplate) {
            notifications.show({
                title: 'Informacja',
                message: 'Domyślne szablony można zresetować, ale nie usuwać. Użyj przycisku "Resetuj".',
                color: 'yellow'
            });
            return;
        }
    ...
    return (
        <Stack gap="md">
            ...
            <Group justify="space-between" align="center">
                <Text fw={600} size="md">Szablony wiadomości SMS</Text>
                <Group gap="xs">
                    <Button
            ...
            <Stack gap="sm">
                {smsTemplates.map((template) => {
                    const isDefault = DEFAULT_SMS_TEMPLATES.some(dt => dt.id === template.id);
                        ...
                        <Card key={template.id} padding="md" radius="md" withBorder>
                            <Stack gap="xs">
                                ...
                                {template.variables.length > 0 && (
                                    <Group gap="xs">
                                        <Text size="xs" c="dimmed">Zmienne:</Text>
            ...
            >
                <Stack gap="md">
                    ...
                    <Stack gap="xs">
                        <Text size="sm" fw={500}>Treść wiadomości</Text>
                        <Textarea
                    ...
                    <Divider label="Szybkie wstawianie zmiennych" labelPosition="center" />
