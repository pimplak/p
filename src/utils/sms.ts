...
export const DEFAULT_SMS_TEMPLATES: SMSTemplate[] = [
    {
        ...
        content: 'Dzień dobry {patientName}! Przypominam o wizycie jutro ({date}) o godzinie {time}. Pozdrawiam, {practitionerName}',
    ...
    },
    {
        ...
        content: 'Dzień dobry {patientName}! Przypominam o dzisiejszej wizycie o godzinie {time}. Pozdrawiam, {practitionerName}',
    ...
    },
    {
        ...
        content: 'Dzień dobry {patientName}! Potwierdzam wizytę w dniu {date} o godzinie {time}. Pozdrawiam, {practitionerName}',
    ...
    },
    {
        ...
        content: 'Dzień dobry {patientName}! Muszę przełożyć naszą wizytę z dnia {oldDate}. Proszę o kontakt w celu umówienia nowego terminu. Pozdrawiam, {practitionerName}',
    ...
    },
    {
        ...
        content: 'Dzień dobry {patientName}! Niestety muszę odwołać wizytę z dnia {date} o godzinie {time}. Proszę o kontakt w celu umówienia nowego terminu. Pozdrawiam, {practitionerName}',
    ...
    },
    {
        ...
        content: 'Dzień dobry {patientName}! Przypominam o naszej pierwszej wizycie jutro ({date}) o godzinie {time}. Proszę przybyć 10 minut wcześniej. Pozdrawiam, {practitionerName}',
    ...
    },
    {
        ...
        content: 'Dzień dobry {patientName}! Minęło już trochę czasu od ostatniej wizyty. Gdyby chciał/a Pan/Pani umówić się na kolejną sesję, proszę o kontakt. Pozdrawiam, {practitionerName}',
...
export function generateSMSMessage(
    ...
    const variables = generateSMSVariables(patient, appointment, practitionerName);
...
export function generateSMSURI(phoneNumber: string, message: string): string {
    ...
    const formattedPhone = cleanPhone.startsWith('+') ? cleanPhone : `+48${cleanPhone}`;
    ...
    try {
        ...
        if (navigator.clipboard) {
            navigator.clipboard.writeText(message).then(() => {
                alert(`Nie udało się otworzyć aplikacji SMS. Wiadomość została skopiowana do schowka:\n\n${message}`);
            });
        } else {
...
export function validatePhoneNumber(phone: string): boolean {
    ...
    return polishMobileRegex.test(cleanPhone) || internationalRegex.test(cleanPhone);
}
